...
class Cityscapes(Custom_dataset):
    def __init__(self, img_list_path, label_list_path, img_size):
        super().__init__(img_list_path, label_list_path, img_size)
        ...
        self.label_transform = transforms.Compose([
            ...
            transforms.Resize(size=img_size, interpolation=InterpolationMode.NEAREST),
        ])
